...
<body>
<div style="margin-left:1130px;width:200px;height:40px;float:left">
...
echo "<form name=myfm method=post action=creview.php>";
echo "<table width=100%> <tr> <td width=30>&nbsp;<td> <table align=center style1=0>";
