...
if($ans->num_rows>=1)
{
	...
	echo "<div style=margin-top:40px;margin-left:400px;width:200px;height:270px;float:left>";
	echo "<table border=2>";
	echo "<caption><h2> C_RESULT </h2></caption>";
	...
	echo "</table><br>";
	echo "<center><a href=administrator.php><input type=button name=back value=Back></button></a></center></div>";
}
else
{
