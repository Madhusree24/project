...
else if($_POST['submit']=='Finish' )
{
	...
	$qn=$_SESSION["qn"];
	$act=("insert into bresult(login,user,maxmarks,marks) values('$login','$user','$qn','$true')");
	if($con->query($act)==true)
	{
		...
		echo "No";
	echo "<h1 align=center><a href=breview.php> Review Question</a> </h1>";
...
echo "<br><br>";
echo "<form name=myfm method=post action=bxam.php>";
