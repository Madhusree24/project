...
if(isset($_POST['insert']))
{
	...
	$sql="insert into ctable(que_id,que_desc,ans1,ans2,ans3,ans4,true_ans)values('$num','$que','$opt1','$opt2','$opt3','$opt4','$corr');";
...
<center><table>
<caption><h2>Insert Questions in C</h2></caption>
